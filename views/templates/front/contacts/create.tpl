            ...
            <div class="form-group">
                <table class="table-bordered table-condensed table-striped">
                    ...
                    {foreach from=$customers item=customer}
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" name="customer_{$idCustomer|escape:'htmlall':'UTF-8'}_check"
                                       value="true">
                            </td>
                            <td>
                                {if isset($customer.name) || isset($customer.name)}
                                    {$customer.name|escape:'htmlall':'UTF-8'}
                                    <input type="hidden" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_name"
                                           name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_name"
                                           value="{$customer.name|escape:'htmlall':'UTF-8'}">
                                {else}
                            ...
                            <td>
                                {if $addressExist && $addressExist}
                                    {if {$customer.addressData|@count} > 1}
                                        <input type="hidden" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_list"
                                               name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_list"
                                               value="selector">
                                        <select id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_option"
                                                class="selectorProfile"
                                                name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_option">
                                    ...
                                    {else}
                                        1
                                        <input type="hidden" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_option"
                                               name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_option" value="0">
                                    {/if}
                                {else}
                                    1
                                    <input type="hidden" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_option"
                            ...
                            <td>
                                {if isset($customer.dniUnique) && $customer.dniUnique == true}
                                    {if $addressExist}
                                        ...
                                        <input type="hidden" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_dni"
                                               name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_dni"
                                               value="{$customer.addressData.0.dni|escape:'htmlall':'UTF-8'}">
                                    {else}
                                        <input type="text" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_dni"
                                               name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_dni">
                                    {/if}
                                {elseif $addressExist}
                                    <select id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_dni"
                                            name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_dni">
                            ...
                            <td>
                                ...
                                <input type="hidden" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_email"
                                       name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_email"
                                       value="{$customer.email|escape:'htmlall':'UTF-8'}">
                            </td>
                            <td>
                                {if $addressExist && $addressExist}
                                    {if {$customer.addressData|@count} > 1}
                                        <select id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_alias"
                                                name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_alias">
                                            <option value="">{l s='Seleccione una opción' mod='mtsalegraapi'}</option>
                                            {for $counter=0 to {$customer.addressData|@count}-1}
                                    ...
                                    {else}
                                        ...
                                        <input type="hidden" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_alias"
                                               name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_alias"
                                               value="{$customer.addressData.0.alias|escape:'htmlall':'UTF-8'}">
                                    {/if}
                                {else}
                            ...
                            <td>
                                {if $addressExist}
                                    {if {$customer.addressData|@count} > 1}
                                        <select id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_phone"
                                                name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_phone">
                                            <option value="">{l s='Seleccione una opción' mod='mtsalegraapi'}</option>
                                            {for $counter=0 to {$customer.addressData|@count}-1}
                                    ...
                                    {else}
                                        ...
                                        <input type="hidden" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_phone"
                                               name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_phone"
                                               value="{$customer.addressData.0.phone|escape:'htmlall':'UTF-8'}">
                                    {/if}
                                {else}
                            ...
                            <td>
                                {if $addressExist}
                                    {if {$customer.addressData|@count} > 1}
                                        <select id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_phone_mobile"
                                                name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_phone_mobile">
                                            <option value="">{l s='Seleccione una opción' mod='mtsalegraapi'}</option>
                                            {for $counter=0 to {$customer.addressData|@count}-1}
                                    ...
                                    {else}
                                        ...
                                        <input type="hidden"
                                               id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_phone_mobile"
                                               name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_phone_mobile"
                                               value="{$customer.addressData.0.phone|escape:'htmlall':'UTF-8'}">
                                    {/if}
                                {else}
                            ...
                            <td>
                                {if $addressExist}
                                    {if {$customer.addressData|@count} > 1}
                                        <select id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_address"
                                                name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_address">
                                            <option value="">{l s='Seleccione una opción' mod='mtsalegraapi'}</option>
                                            {for $counter=0 to {$customer.addressData|@count}-1}
                                    ...
                                    {else}
                                        ...
                                        {if isset($customer.addressData.0.address2) && !empty($customer.addressData.0.address2)}
                                            , {$customer.addressData.0.address2|escape:'htmlall':'UTF-8'}
                                        {/if}
                                        <input type="hidden" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_address"
                                               name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_address"
                                               value="{$customer.addressData.0.address1|escape:'htmlall':'UTF-8'}{if isset($customer.addressData.0.address2) && !empty($customer.addressData.0.address2)}, {$customer.addressData.0.address2|escape:'htmlall':'UTF-8'}{/if}">
                                    {/if}
                                {else}
                            ...
                            <td>
                                {if $addressExist}
                                    {if {$customer.addressData|@count} > 1}
                                        <select id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_location"
                                                name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_location">
                                            <option value="">{l s='Seleccione una opción' mod='mtsalegraapi'}</option>
                                            {for $counter=0 to {$customer.addressData|@count}-1}
                                                <option value="{$counter|escape:'htmlall':'UTF-8'}">{$customer.addressData.{$counter}.city|escape:'htmlall':'UTF-8'}
                                                    /{$customer.addressData.{$counter}.state|escape:'htmlall':'UTF-8'}
                                                    /{$customer.addressData.{$counter}.country|escape:'htmlall':'UTF-8'}</option>
                                            {/for}
                                        </select>
                                    {else}
                                        ...
                                        <input type="hidden"
                                               id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_location"
                                               name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_location"
                                               value="{$customer.addressData.0.city|escape:'htmlall':'UTF-8'}/{$customer.addressData.0.state|escape:'htmlall':'UTF-8'}/{$customer.addressData.0.country|escape:'htmlall':'UTF-8'}">
                                    {/if}
                                {else}
                            ...
                            <td>
                                <input type="text" id="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_observations"
                                       name="contact_{$idCustomer|escape:'htmlall':'UTF-8'}_observations">
                            </td>
                        </tr>
                    {/foreach}
                </table>
