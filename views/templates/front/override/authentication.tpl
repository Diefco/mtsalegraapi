            ...
            <div class="box">
                <div id="opc_account_form" style="display: block; ">
                    ...
                    <div class="required form-group">
                        ...
                        <select name="dni_type" id="dni_type">
                            <option value="invalid">{l s='--' mod='mtsalegraapi'}</option>
                            <option value="CC"
                                    {if isset($smarty.post.dni_type) && $smarty.post.dni_type == 'CC'}selected{/if}>{l s='CC' mod='mtsalegraapi'}</option>
                            <option value="CE"
                                    {if isset($smarty.post.dni_type) && $smarty.post.dni_type == 'CE'}selected{/if}>{l s='CE' mod='mtsalegraapi'}</option>
                            <option value="NIT"
                                    {if isset($smarty.post.dni_type) && $smarty.post.dni_type == 'NIT'}selected{/if}>{l s='NIT' mod='mtsalegraapi'}</option>
                            <option value="TI"
                                    {if isset($smarty.post.dni_type) && $smarty.post.dni_type == 'TI'}selected{/if}>{l s='TI' mod='mtsalegraapi'}</option>
                            <option value="PP"
                                    {if isset($smarty.post.dni_type) && $smarty.post.dni_type == 'PP'}selected{/if}>{l s='PP' mod='mtsalegraapi'}</option>
                            <option value="IDC"
                                    {if isset($smarty.post.dni_type) && $smarty.post.dni_type == 'IDC'}selected{/if}>{l s='IDC' mod='mtsalegraapi'}</option>
                            <option value="CEL"
                                    {if isset($smarty.post.dni_type) && $smarty.post.dni_type == 'CEL'}selected{/if}>{l s='CEL' mod='mtsalegraapi'}</option>
                            <option value="RC"
                                    {if isset($smarty.post.dni_type) && $smarty.post.dni_type == 'RC'}selected{/if}>{l s='RC' mod='mtsalegraapi'}</option>
                            <option value="DE"
