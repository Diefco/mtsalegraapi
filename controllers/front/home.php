...
class MtsAlegraApiHomeModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        $url = array(
            //Products
            'productConsultOne' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'productConsultOne',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'productConsultMultiple' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'productConsultMultiple',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'productCreate' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'productCreate',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'productEdit' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'productEdit',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'productDelete' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'productDelete',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ...
            //Contacts
            'contactConsultOne' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'contactConsultOne',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'contactConsultMultiple' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'contactConsultMultiple',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'contactCreate' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'contactCreate',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'contactEdit' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'contactEdit',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'contactDelete' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'contactDelete',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ...
            //Invoices
            'invoiceConsultOne' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'invoiceConsultOne',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'invoiceConsultMultiple' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'invoiceConsultMultiple',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'invoiceCreate' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'invoiceCreate',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'invoiceEdit' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'invoiceEdit',
                array(),
                Configuration::get('PS_SSL_ENABLED')
            ),
            'invoiceDelete' => $this->context->link->getModuleLink(
                'mtsalegraapi',
                'invoiceDelete',
                array(),
                Configuration::get('PS_SSL_ENABLED')
        ...
        $this->context->smarty->assign('urlLogOut', $this->context->link->getModuleLink(
            'mtsalegraapi',
            'home',
            array(),
            Configuration::get('PS_SSL_ENABLED')
