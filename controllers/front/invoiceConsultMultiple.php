...
class MtsAlegraApiInvoiceConsultMultipleModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
         ...
         * @var int     start               Opcional    Must contain the Invoice ID registered on Alegra. This ID will be the product when the consult start
         * @var int     limit               Opcional    Must contain the quantity of invoices to be consulted. Max number is 30
        ...
        if (count($queryArray) >= 1) {
            ...
            $url = 'https://app.alegra.com/api/v1/invoices/?' . $queryURL;
            echo $url;
//            $url = 'https://app.alegra.com/api/v1/invoices/';
            ...
            $invoiceList = json_decode($jsonRequest, true);
